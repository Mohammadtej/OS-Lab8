...
main(int argc, char *argv[])
{
  ...
  12:	89258593          	addi	a1,a1,-1902 # 8a0 <malloc+0xec>
  16:	4509                	li	a0,2
  18:	00000097          	auipc	ra,0x0
  1c:	6b0080e7          	jalr	1712(ra) # 6c8 <fprintf>
    exit(1);
  20:	4505                	li	a0,1
  22:	00000097          	auipc	ra,0x0
  26:	35c080e7          	jalr	860(ra) # 37e <exit>
  }
  ...
  32:	360080e7          	jalr	864(ra) # 38e <pipe>

  if (fork() == 0) {
  36:	00000097          	auipc	ra,0x0
  3a:	340080e7          	jalr	832(ra) # 376 <fork>
  3e:	e931                	bnez	a0,92 <main+0x92>
    read(p[0], buf, 4);
  40:	4611                	li	a2,4
  42:	fe040593          	addi	a1,s0,-32
  46:	fe842503          	lw	a0,-24(s0)
  4a:	00000097          	auipc	ra,0x0
  4e:	34c080e7          	jalr	844(ra) # 396 <read>
    fprintf(1, "%d: received %s\n", getpid(), buf);
  52:	00000097          	auipc	ra,0x0
  56:	3ac080e7          	jalr	940(ra) # 3fe <getpid>
  5a:	862a                	mv	a2,a0
  5c:	fe040693          	addi	a3,s0,-32
  60:	00001597          	auipc	a1,0x1
  64:	85858593          	addi	a1,a1,-1960 # 8b8 <malloc+0x104>
  68:	4505                	li	a0,1
  6a:	00000097          	auipc	ra,0x0
  6e:	65e080e7          	jalr	1630(ra) # 6c8 <fprintf>
    write(p[1], "pong", 4);
  72:	4611                	li	a2,4
  74:	00001597          	auipc	a1,0x1
  78:	85c58593          	addi	a1,a1,-1956 # 8d0 <malloc+0x11c>
  7c:	fec42503          	lw	a0,-20(s0)
  80:	00000097          	auipc	ra,0x0
  84:	31e080e7          	jalr	798(ra) # 39e <write>
    exit(0);
  88:	4501                	li	a0,0
  8a:	00000097          	auipc	ra,0x0
  8e:	2f4080e7          	jalr	756(ra) # 37e <exit>
  } else {
    write(p[1], "ping", 4);
  92:	4611                	li	a2,4
  94:	00001597          	auipc	a1,0x1
  98:	84458593          	addi	a1,a1,-1980 # 8d8 <malloc+0x124>
  9c:	fec42503          	lw	a0,-20(s0)
  a0:	00000097          	auipc	ra,0x0
  a4:	2fe080e7          	jalr	766(ra) # 39e <write>
    wait(0);
  a8:	4501                	li	a0,0
  aa:	00000097          	auipc	ra,0x0
  ae:	2dc080e7          	jalr	732(ra) # 386 <wait>
    read(p[0], buf, 4);
  b2:	4611                	li	a2,4
  b4:	fe040593          	addi	a1,s0,-32
  b8:	fe842503          	lw	a0,-24(s0)
  bc:	00000097          	auipc	ra,0x0
  c0:	2da080e7          	jalr	730(ra) # 396 <read>
    fprintf(1, "%d: received %s\n", getpid(), buf);
  c4:	00000097          	auipc	ra,0x0
  c8:	33a080e7          	jalr	826(ra) # 3fe <getpid>
  cc:	862a                	mv	a2,a0
  ce:	fe040693          	addi	a3,s0,-32
  d2:	00000597          	auipc	a1,0x0
  d6:	7e658593          	addi	a1,a1,2022 # 8b8 <malloc+0x104>
  da:	4505                	li	a0,1
  dc:	00000097          	auipc	ra,0x0
  e0:	5ec080e7          	jalr	1516(ra) # 6c8 <fprintf>
  }
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 466:	48650513          	addi	a0,a0,1158 # 8e8 <digits>
 46a:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 532:	3bab8b93          	addi	s7,s7,954 # 8e8 <digits>
 ...
 672:	27290913          	addi	s2,s2,626 # 8e0 <malloc+0x12c>
        while(*s != 0){
