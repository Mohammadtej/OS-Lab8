...
main(int argc, char *argv[])
{
  ...
  12:	89258593          	addi	a1,a1,-1902 # 8a0 <malloc+0xe4>
  16:	4509                	li	a0,2
  18:	00000097          	auipc	ra,0x0
  1c:	6b8080e7          	jalr	1720(ra) # 6d0 <fprintf>
    exit(1);
  20:	4505                	li	a0,1
  ...
  64:	85858593          	addi	a1,a1,-1960 # 8b8 <malloc+0xfc>
  68:	4505                	li	a0,1
  6a:	00000097          	auipc	ra,0x0
  6e:	666080e7          	jalr	1638(ra) # 6d0 <fprintf>
    write(p[1], "pong", 4);
  72:	4611                	li	a2,4
  74:	00001597          	auipc	a1,0x1
  78:	85c58593          	addi	a1,a1,-1956 # 8d0 <malloc+0x114>
  ...
  98:	84458593          	addi	a1,a1,-1980 # 8d8 <malloc+0x11c>
  ...
  d6:	7e658593          	addi	a1,a1,2022 # 8b8 <malloc+0xfc>
  da:	4505                	li	a0,1
  dc:	00000097          	auipc	ra,0x0
  e0:	5f4080e7          	jalr	1524(ra) # 6d0 <fprintf>
  }
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 46e:	47e50513          	addi	a0,a0,1150 # 8e8 <digits>
 472:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 53a:	3b2b8b93          	addi	s7,s7,946 # 8e8 <digits>
 ...
 67a:	26a90913          	addi	s2,s2,618 # 8e0 <malloc+0x124>
        while(*s != 0){
