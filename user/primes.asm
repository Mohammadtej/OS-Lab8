...
filter(int *pin)
{
  ...
  3c:	8e850513          	addi	a0,a0,-1816 # 920 <malloc+0xec>
...
main(int argc, char *argv[])
{
  ...
  d2:	86258593          	addi	a1,a1,-1950 # 930 <malloc+0xfc>
  d6:	4509                	li	a0,2
  d8:	00000097          	auipc	ra,0x0
  dc:	670080e7          	jalr	1648(ra) # 748 <fprintf>
    exit(1);
  e0:	4505                	li	a0,1
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 4e6:	46650513          	addi	a0,a0,1126 # 948 <digits>
 4ea:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 5b2:	39ab8b93          	addi	s7,s7,922 # 948 <digits>
 ...
 6f2:	25290913          	addi	s2,s2,594 # 940 <malloc+0x10c>
        while(*s != 0){
