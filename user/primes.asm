...
filter(int *pin)
{
  ...
  14:	3f6080e7          	jalr	1014(ra) # 406 <pipe>
  close(pin[1]);
  18:	40c8                	lw	a0,4(s1)
  1a:	00000097          	auipc	ra,0x0
  1e:	404080e7          	jalr	1028(ra) # 41e <close>
  if (read(pin[0], &n, sizeof(int))) {
  22:	4611                	li	a2,4
  24:	fdc40593          	addi	a1,s0,-36
  28:	4088                	lw	a0,0(s1)
  2a:	00000097          	auipc	ra,0x0
  2e:	3e4080e7          	jalr	996(ra) # 40e <read>
  32:	c149                	beqz	a0,b4 <filter+0xb4>
    printf("prime %d\n", n);
  34:	fdc42583          	lw	a1,-36(s0)
  38:	00001517          	auipc	a0,0x1
  3c:	8d850513          	addi	a0,a0,-1832 # 910 <malloc+0xe4>
  40:	00000097          	auipc	ra,0x0
  44:	72e080e7          	jalr	1838(ra) # 76e <printf>
    if (fork() == 0) {
  ...
  76:	39c080e7          	jalr	924(ra) # 40e <read>
  ...
  98:	382080e7          	jalr	898(ra) # 416 <write>
  ...
  a6:	37c080e7          	jalr	892(ra) # 41e <close>
      wait(0);
  aa:	4501                	li	a0,0
  ac:	00000097          	auipc	ra,0x0
  b0:	352080e7          	jalr	850(ra) # 3fe <wait>
    }
  }
  exit(0);
  b4:	4501                	li	a0,0
  b6:	00000097          	auipc	ra,0x0
  ba:	340080e7          	jalr	832(ra) # 3f6 <exit>
...
main(int argc, char *argv[])
{
  ...
  d2:	85258593          	addi	a1,a1,-1966 # 920 <malloc+0xf4>
  d6:	4509                	li	a0,2
  d8:	00000097          	auipc	ra,0x0
  dc:	668080e7          	jalr	1640(ra) # 740 <fprintf>
    exit(1);
  e0:	4505                	li	a0,1
  e2:	00000097          	auipc	ra,0x0
  e6:	314080e7          	jalr	788(ra) # 3f6 <exit>
  }
  ...
  fe:	e519                	bnez	a0,10c <main+0x4e>
    filter(p);
 100:	fd840513          	addi	a0,s0,-40
 104:	00000097          	auipc	ra,0x0
 108:	efc080e7          	jalr	-260(ra) # 0 <filter>
    exit(0);
  } else {
    close(p[0]);
 10c:	fd842503          	lw	a0,-40(s0)
 110:	00000097          	auipc	ra,0x0
 114:	30e080e7          	jalr	782(ra) # 41e <close>
    for (int i = 2; i <= 35; ++i) {
 118:	4789                	li	a5,2
 ...
 130:	2ea080e7          	jalr	746(ra) # 416 <write>
    for (int i = 2; i <= 35; ++i) {
 134:	fd442783          	lw	a5,-44(s0)
 138:	2785                	addiw	a5,a5,1
 13a:	0007871b          	sext.w	a4,a5
 13e:	fcf42a23          	sw	a5,-44(s0)
 142:	fee4d0e3          	bge	s1,a4,122 <main+0x64>
    }
    close(p[1]);
 146:	fdc42503          	lw	a0,-36(s0)
 14a:	00000097          	auipc	ra,0x0
 14e:	2d4080e7          	jalr	724(ra) # 41e <close>
    wait(0);
 152:	4501                	li	a0,0
 154:	00000097          	auipc	ra,0x0
 158:	2aa080e7          	jalr	682(ra) # 3fe <wait>
  }
...
_main()
{
 ...
 172:	f50080e7          	jalr	-176(ra) # be <main>
  exit(0);
 176:	4501                	li	a0,0
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 4de:	45e50513          	addi	a0,a0,1118 # 938 <digits>
 4e2:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 5aa:	392b8b93          	addi	s7,s7,914 # 938 <digits>
 ...
 6ea:	24a90913          	addi	s2,s2,586 # 930 <malloc+0x104>
        while(*s != 0){
